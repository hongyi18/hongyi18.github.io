...
<figure>
  ...
  <center>
    <figcaption style="width:100%"> <em>Extremely polarized (left two) and hedgehog (right) vector solitons. Arrows stand for the magnitude and direction of the spatial part of a Lorentz 4-vector field, and the background color represents its energy density. In the nonrelativistic limit, the average particle spin in linearly polarized (left) and hedgehog (right) solitons is 0 while it is 1 in circularly polarized configurations (middle). </em>
    </figcaption>
  </center>
</figure>
